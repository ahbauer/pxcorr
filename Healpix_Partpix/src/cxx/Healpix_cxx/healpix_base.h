...
class Healpix_Base2;
template<typename T> class Partpix_Map;
template<typename T> class Partpix_Map2;
...
class Healpix_Base
  ...
  public:
      ...
      friend class Partpix_Map<int>;
      friend class Partpix_Map<double>;
      friend class Partpix_Map2<int>;
      friend class Partpix_Map2<float>;
      friend class Partpix_Map2<double>;
