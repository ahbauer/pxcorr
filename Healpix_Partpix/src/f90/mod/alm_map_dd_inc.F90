...
#ifdef USE_PSHT
    call psht_hp_alm2map_x_d(nsmax,nlmax,nmmax,alm,map)
#else
...
!$OMP end parallel
  ...
  subroutine alm2map_spin_d(nsmax, nlmax, nmmax, spin, alm, map)
    ...
    if ((aspin>0).and.(aspin<=100)) then
      call psht_hp_alm2map_spin_x_d(nsmax,nlmax,nmmax,aspin, &
...
#ifdef USE_PSHT
    call psht_hp_alm2map_pol_x_d(nsmax,nlmax,nmmax,alm_TGC,map_TQU)
#else
...
!   END subroutine map2alm_sc_test_d
  ...
  subroutine map2alm_sc_d(nsmax, nlmax, nmmax, map, alm, zbounds, w8ring)
    ...
    call psht_hp_map2alm_x_d(nsmax,nlmax,nmmax,map,alm,zbounds_in,w8ring_in)
#else
...
!$OMP end parallel
  ...
  subroutine map2alm_spin_d(nsmax, nlmax, nmmax, spin, map, alm, zbounds, w8ring)
    ...
    aspin = abs(spin)
    if ((aspin>0).and.(aspin<=100)) then
      call psht_hp_map2alm_spin_x_d(nsmax,nlmax,nmmax,aspin, &
...
!   end subroutine map2alm_pol_test_d
  ...
  subroutine map2alm_pol_d(nsmax, nlmax, nmmax, map_TQU,&
    ...
    call psht_hp_map2alm_pol_x_d(nsmax,nlmax,nmmax,map_TQU,alm_TGC,zbounds_in,w8ring_in)
#else
...
!              zeta3_i = randgauss_boxmuller(iseed) * hsqrt2
  ...
  !========================================================
  subroutine alm2cl2_d(nlmax, nmmax, alm1, alm2, cl)
  !========================================================
