...
! K L O A D : suffixe of routine name, to be replaced by either s (SP) or d (DP)
  !=======================================================================
  subroutine sub_udgrade_nest_d(map_in, nside_in, map_out, nside_out, fmissval, pessimistic)
    !=======================================================================
    !
    ...
    REAL(DP),     INTENT(IN),  DIMENSION(0:), target :: map_in
    REAL(DP),     INTENT(OUT), DIMENSION(0:) :: map_out
    ...
    REAL(DP)   :: bad_value, threshold, value
    real(DP)     :: total
    !-----------------------------------------------------------------------
...
!$OMP end parallel
    ...
    return
  end subroutine sub_udgrade_nest_d
!=======================================================================
  !
  ...
  subroutine udgrade_ring_1d_d(map_in, nside_in, map_out, nside_out, fmissval, pessimistic)
    ...
    INTEGER(I4B), INTENT(IN) :: nside_in, nside_out
    REAL(DP), INTENT(INOUT), dimension(0:), target :: map_in
    REAL(DP), INTENT(OUT), dimension(0:),   target :: map_out
    REAL(DP), INTENT(IN), OPTIONAL :: fmissval
    LOGICAL(LGT) , INTENT(IN), OPTIONAL :: pessimistic
  ...
  subroutine udgrade_ring_nd_d(map_in, nside_in, map_out, nside_out, fmissval, pessimistic)
    ...
    USE pix_tools, only : nside2npix, ring2nest, convert_ring2nest, convert_nest2ring
    INTEGER(I4B), INTENT(IN) :: nside_in, nside_out
    REAL(DP), INTENT(INOUT), dimension(0:,1:), target :: map_in
    REAL(DP), INTENT(OUT),   dimension(0:,1:), target :: map_out
    REAL(DP), INTENT(IN), OPTIONAL :: fmissval
    LOGICAL(LGT) , INTENT(IN), OPTIONAL :: pessimistic

    INTEGER(I8B) :: npix_in, npix_out
    INTEGER(I4B) :: nd_in, nd_out, id
    real(DP), dimension(:), pointer :: p_in, p_out
    !-----------------------------------------------------------------------
  ...
  subroutine udgrade_nest_1d_d(map_in, nside_in, map_out, nside_out, fmissval, pessimistic)
    ...
    USE pix_tools, only : nside2npix
    INTEGER(I4B), INTENT(IN) :: nside_in, nside_out
    REAL(DP), INTENT(IN), dimension(0:)  :: map_in
    REAL(DP), INTENT(OUT), dimension(0:) :: map_out
    REAL(DP), INTENT(IN), OPTIONAL :: fmissval
    LOGICAL(LGT) , INTENT(IN), OPTIONAL :: pessimistic
  ...
  subroutine udgrade_nest_nd_d(map_in, nside_in, map_out, nside_out, fmissval, pessimistic)
    ...
    USE pix_tools, only : nside2npix
    INTEGER(I4B), INTENT(IN) :: nside_in, nside_out
    REAL(DP), INTENT(IN),  dimension(0:,1:), target :: map_in
    REAL(DP), INTENT(OUT), dimension(0:,1:), target :: map_out
    REAL(DP), INTENT(IN), OPTIONAL :: fmissval
    LOGICAL(LGT) , INTENT(IN), OPTIONAL :: pessimistic
